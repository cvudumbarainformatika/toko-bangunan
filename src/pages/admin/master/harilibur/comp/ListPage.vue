            ...
            >
              ...
              >
                ...
                >
                  ...
                  <q-item-section>
                    <q-item-label lines="1">{{ humanDate(item?.tgl) }}</q-item-label>
                    <q-item-label caption lines="2">
                      <span class="text-weight-bold">{{ item?.keterangan }}</span>
                    </q-item-label>
                  </q-item-section>
...
import { useAdminMasterListHariLibur } from 'src/stores/admin/master/harilibur/list'
import { computed, onBeforeMount, ref } from 'vue'

const store = useAdminMasterListHariLibur()
