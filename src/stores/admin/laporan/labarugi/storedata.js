...
export const useLaporanLabaRugi = defineStore('laporan-labarugi-store', {
  state: () => ({
    params: {
      q: null,
      page: 0,
  ...
  actions: {
    ...
    async getdata() {
      ...
      return new Promise((resolve, reject) => {
        api
          .get('/v1/laporan/labarugi/getlabarugi', params)
          .then(({ data }) => {
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useLaporanLabaRugi, import.meta.hot))
}
