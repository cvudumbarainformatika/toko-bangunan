...
export const useLaporanArusKas = defineStore('laporan-aruskas-store', {
  state: () => ({
    params: {
      q: null,
      page: 0,
  ...
  actions: {
    ...
    async getdata() {
      ...
      return new Promise((resolve, reject) => {
        api
          .get('/v1/laporan/aruskas/getaruskas', params)
          .then(({ data }) => {
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useLaporanArusKas, import.meta.hot))
}
