...
export const useListTransaksiPenyesuaianStore = defineStore('admin-list-penyesuaian-store', {
  state: () => ({
    meta: null,
    items: [],
    isError: false,
  ...
  actions: {
    ...
    async getList() {
      ...
      try {
        const { data } = await api.get('/v1/transaksi/penyesuaian/data', params)
    ...
    loadMore(index, done) {
      ...
      return new Promise((resolve) => {
        api
          .get('/v1/transaksi/penyesuaian/data', params)
          .then(({ data }) => {
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useListTransaksiPenyesuaianStore, import.meta.hot))
}
